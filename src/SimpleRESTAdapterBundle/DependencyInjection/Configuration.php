...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $treeBuilder->getRootNode()
            ...
            ->children()
                ->scalarNode('engine')
                    ->info('Search engine client to use: opensearch or elasticsearch.')
                    ->defaultValue('opensearch')
                    ->validate()
                        ->ifNotInArray(['opensearch', 'elasticsearch'])
                        ->thenInvalid('Invalid search engine "%s". Allowed values: opensearch, elasticsearch.')
                    ->end()
                ->end()
                ...
                ->end()
                ->arrayNode('hosts')
                    ->info('Generic list of search engine hosts. If empty, es_hosts is used for backward compatibility.')
                    ->prototype('scalar')->end()
                    ->defaultValue([])
                ->end()
